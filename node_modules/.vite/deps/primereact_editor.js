...
var Editor = React4.memo(React4.forwardRef(function(inProps, ref) {
  ...
  var toolbarRef = React4.useRef(null);
  var quill = React4.useRef(null);
  var isQuillLoaded = React4.useRef(false);
  var _React$useState = React4.useState(false), _React$useState2 = _slicedToArray3(_React$useState, 2), quillCreated = _React$useState2[0], setQuillCreated = _React$useState2[1];
  useMountEffect(function() {
    if (!isQuillLoaded.current) {
      var configuration = {
        modules: _objectSpread3({
      ...
      if (QuillJS) {
        ...
        import("./quill-OK5SGN4V.js").then(function(module) {
  ...
  var initValue = (0, import_react3.useRef)(props.value);
  ...
  var createToolbarHeader = function createToolbarHeader2() {
    ...
    if (props.showHeader === false) {
      ...
      return React4.createElement("div", toolbarProps, props.headerTemplate);
    }
    var getMergeProps = function getMergeProps2(params, key) {
      return mergeProps2(params && _objectSpread3({}, params), ptm(key));
    };
    var formatsProps = mergeProps2({
      className: "ql-formats"
    }, ptm("formats"));
    return React4.createElement("div", toolbarProps, React4.createElement("span", formatsProps, React4.createElement("select", getMergeProps({
      className: "ql-header",
      defaultValue: "0"
    }, "header"), React4.createElement("option", getMergeProps({
      value: "1"
    }, "option"), "Heading"), React4.createElement("option", getMergeProps({
      value: "2"
    }, "option"), "Subheading"), React4.createElement("option", getMergeProps({
      value: "0"
    }, "option"), "Normal")), React4.createElement("select", getMergeProps({
      className: "ql-font"
    }, "font"), React4.createElement("option", getMergeProps(void 0, "option")), React4.createElement("option", getMergeProps({
      value: "serif"
    }, "option")), React4.createElement("option", getMergeProps({
      value: "monospace"
    }, "option")))), React4.createElement("span", formatsProps, React4.createElement("button", getMergeProps({
      type: "button",
      className: "ql-bold",
      "aria-label": "Bold"
    }, "bold")), React4.createElement("button", getMergeProps({
      type: "button",
      className: "ql-italic",
      "aria-label": "Italic"
    }, "italic")), React4.createElement("button", getMergeProps({
      type: "button",
      className: "ql-underline",
      "aria-label": "Underline"
    }, "underline"))), React4.createElement("span", formatsProps, React4.createElement("select", getMergeProps({
      className: "ql-color"
    }, "color")), React4.createElement("select", getMergeProps({
      className: "ql-background"
    }, "background"))), React4.createElement("span", formatsProps, React4.createElement("button", getMergeProps({
      type: "button",
      className: "ql-list",
      value: "ordered",
      "aria-label": "Ordered List"
    }, "list")), React4.createElement("button", getMergeProps({
      type: "button",
      className: "ql-list",
      value: "bullet",
      "aria-label": "Unordered List"
    }, "list")), React4.createElement("select", getMergeProps({
      className: "ql-align"
    }, "select"), React4.createElement("option", getMergeProps({
      defaultValue: true
    }, "option")), React4.createElement("option", getMergeProps({
      value: "center"
    }, "option")), React4.createElement("option", getMergeProps({
    ...
    }, "link")), React4.createElement("button", getMergeProps({
      type: "button",
      className: "ql-image",
      "aria-label": "Insert Image"
    }, "image")), React4.createElement("button", getMergeProps({
      type: "button",
      className: "ql-code-block",
      "aria-label": "Insert Code Block"
    }, "codeBlock"))), React4.createElement("span", formatsProps, React4.createElement("button", getMergeProps({
      type: "button",
      className: "ql-clean",
  ...
  var content = React4.createElement("div", contentProps);
